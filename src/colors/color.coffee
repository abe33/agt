...
class Color
  ...
  @colorComponents.forEach ([component, index]) =>
    Object.defineProperty Color::, component, {
      enumerable: true
      get: -> @[index]
      set: (component) ->
        @[index] = component
  ...
  Object.defineProperty Color::, 'hsv', {
    enumerable: true
  ...
  Object.defineProperty Color::, 'hwb', {
    enumerable: true
  ...
  Object.defineProperty Color::, 'hexARGB', {
    enumerable: true
  ...
  Object.defineProperty Color::, 'length', {
    enumerable: true
    get: -> 4
  }
  ...
  Object.defineProperty Color::, 'lightness', {
    enumerable: true
    get: -> @hsl[2]
    set: (lightness) ->
      hsl = @hsl
