(function() {
  ...
  agt.geom.LinearSpline = (function() {
    ...
    function LinearSpline(vertices) {
      this.initSpline(vertices);
    }
  ...
  agt.geom.Matrix = (function() {
    ...
    Matrix.prototype.transformPoint = function(x, y) {
      ...
      _ref7 = Point.pointFrom(x, y, true), x = _ref7.x, y = _ref7.y;
    ...
    Matrix.prototype.translate = function(x, y) {
      ...
      _ref7 = Point.pointFrom(x, y), x = _ref7.x, y = _ref7.y;
      this.tx += x;
      this.ty += y;
      return this;
    };
    ...
    Matrix.prototype.skew = function(x, y) {
      ...
      this.append(Math.cos(pt.y), Math.sin(pt.y), -Math.sin(pt.x), Math.cos(pt.x));
      return this;
    };
  ...
  widgets.domEvent = function(type, data, options) {
    var bubbles, cancelable, e, event, _ref12;
    if (data == null) {
      data = {};
    }
    if (options == null) {
      options = (_ref12 = {}, bubbles = _ref12.bubbles, cancelable = _ref12.cancelable, _ref12);
    }
    try {
  ...
  widgets.$define = function(name, baseOptions, block) {
    ...
    if (typeof baseOptions === 'function') {
      _ref12 = [{}, baseOptions], baseOptions = _ref12[0], block = _ref12[1];
    }
    if (!$.fn[name]) {
  ...
  widgets.release = function() {
    ...
    for (_i = 0, _len = names.length; _i < _len; _i++) {
      name = names[_i];
      _results.push(__instances__[name].each(function(value) {
