(function() {
  var DEFAULT_RANDOM, DEFAULT_UNGLOBALIZABLE, Ellipsis, Geometry, Impulse, Intersections, MathRandom, NullAction, NullCounter, NullEmitter, NullInitializer, NullTimer, Particle, Path, Point, Proxyable, Random, Randomizable, Signal, Spline, SubSystem, Surface, Triangle, Triangulable, agt, build, exports, findCaller, floor, g, geom, isCommonJS, mixins, particles, random, registerSuper, requestAnimFrame, round, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  agt.mixins.Cloneable = function() {
    ...
    return ConcreteCloneable = (function() {
      ...
      if (properties.length === 0) {
        ...
        ConcreteCloneable.included = function(klass) {
          return klass.prototype.clone = function() {
            return build(klass, properties.map((function(_this) {
              return function(p) {
                return _this[p];
              };
            })(this)));
  ...
  agt.geom.Spline = function(segmentSize) {
    var ConcretSpline;
    return ConcretSpline = (function() {
      function ConcretSpline() {}

      ConcretSpline.include(mixins.Memoizable);
  ...
  agt.geom.Triangle = (function() {
    ...
    Triangle.prototype.adCenter = function() {};

    ['abCenter', 'acCenter', 'bcCenter'].forEach(function(k) {
      var p1, p2, _ref1;
      _ref1 = k.split(''), p1 = _ref1[0], p2 = _ref1[1];
    ...
    ['abc', 'bac', 'acb'].forEach(function(k) {
      var p1, p2, p3, _ref1;
      _ref1 = k.split(''), p1 = _ref1[0], p2 = _ref1[1], p3 = _ref1[2];
      return Triangle.prototype[k] = function() {
  ...
  agt.geom.Rectangle = (function() {
    ...
    Rectangle.prototype.contains = function(xOrPt, y) {
      var x, _ref2;
      _ref2 = new Point(xOrPt, y).rotateAround(this.topLeft(), -this.rotation), x = _ref2.x, y = _ref2.y;
  ...
  agt.geom.Circle = (function() {
    ...
    Circle.include(mixins.Equatable('x', 'y', 'radius'));

    Circle.include(mixins.Formattable('Circle', 'x', 'y', 'radius'));
    ...
    Circle.include(mixins.Sourcable('agt.geom.Circle', 'radius', 'x', 'y'));
    ...
    function Circle(radiusOrCircle, x, y, segments) {
      var _ref3;
      _ref3 = this.circleFrom(radiusOrCircle, x, y, segments), this.radius = _ref3.radius, this.x = _ref3.x, this.y = _ref3.y, this.segments = _ref3.segments;
    }
    ...
    Circle.prototype.translate = function(xOrPt, y) {
      var x, _ref3;
      _ref3 = Point.pointFrom(xOrPt, y), x = _ref3.x, y = _ref3.y;
      this.x += x;
      this.y += y;
      return this;
    };
  ...
  agt.particles.initializers.Explosion = (function() {
    Explosion.include(Randomizable);
